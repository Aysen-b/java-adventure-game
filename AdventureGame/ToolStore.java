...
public class ToolStore extends NormalLocation  {
    ...
    public int armorMenu(){
        System.out.println("1. Hafif -> para = 15   Kalkan = 1");
        System.out.println("2. Orta -> para = 25    Kalkan = 3");
        System.out.println("3. Ağır -> para = 40    Kalkan = 5");
        ...
        String wName = null;
            ...
            if(price >0) {
                ...
                if (player.getMoney() >= price) {
                    ...
                    System.out.println(wName + " satın aldınız! Eski Hasarınız =" + player.getDamage() + "   Yeni Hasar = "
